...
@section('content_header')
    <h1 class="m-0 text-dark">Добавить задание</h1>
@stop
    ...
    <div class="card card-danger">
        ...
        <div class="card-body">
            <div class="form-group">
                ...
                {!! Form::textarea('content', null,['class' => 'form-control','id' => 'summernote', 'cols' => 30, 'rows' => 20]); !!}
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                {!! Form::textarea('solution', null,['class' => 'form-control','id' => 'summernote2', 'cols' => 30, 'rows' => 20]); !!}
            </div>
